...
<template>
    ...
    >
        <SwitchThumb
            ...
            class="bg-background pointer-events-none block size-5 rounded-full ring-0 shadow-lg transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0"
        />
    </SwitchRoot>
</template>
