...
| Player moment input (the player half of the loop) | **S-5.1.1** ([ADR 0016](../../adr/0016-narrator-agent-and-turn-loop.md)) | **Built** → [S-5.1.1-player-input.md](./S-5.1.1-player-input.md) |
