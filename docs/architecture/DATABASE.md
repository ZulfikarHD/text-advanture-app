...
| Column | Type | Notes |
|--------|------|-------|
| `user_id` | FK → `users` `NULL` | owner scope (S-6.2, PH-20); null-session authoring proposals are isolated per account via `BelongsToOwner` |
