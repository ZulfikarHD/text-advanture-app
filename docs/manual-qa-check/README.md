...
| [ui/S-11-play-loop.md](./ui/S-11-play-loop.md) | S-5.4.1, S-5.1.1, S-4.2.1, S-3.1.2 — Writing/Play loop: enter play, narrator turn, player moment input, continue/end, recoverable failure |
